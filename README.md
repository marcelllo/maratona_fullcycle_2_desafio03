# Repositório do Desafio 03 da Maratona DevFullCycle 2.0
...
```
$ npm run build
$ docker build -t marcellosantos/maratona-fullcycle-desafio03 .
$ docker push marcellosantos/maratona-fullcycle-desafio03
```

### Executando no server a partir da imagem do DockerHub
```
$ docker pull marcellosantos/maratona-fullcycle-desafio03
$ docker run -p 3000:3000 marcellosantos/maratona-fullcycle-desafio03
```
